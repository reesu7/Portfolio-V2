<script>
  ...
  let posters = [
    "codechef.png","codeforces.png","leetcode.png"
  ];
  let currentIndex = 0;
</script>
...
>
  ...
  <header class="px-5 relative lg:flex pt-40 pb-24 gap-10 text-center">
    ...
    <div data-aos="fade-left" data-aos-delay="200" class="basis-1/2">
      ...
      >
        I am a active competitive programmer with 1000+ questions across platforms like leetcode,codeforces,codechef. Here are my coding profiles
      </p>
    </div>
  </header>
