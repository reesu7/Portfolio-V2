<script>
  ...
  async function submitForm() {
    ...
    if (res.ok) {
      ...
      alert(
        "Uh oh... message failed to send. You can email me directly at rishurawat1703@gmail.com"
      );
    }
  }
</script>
        ...
        <div class="basis-2/5">
          ...
          <h5 data-aos="fade" class="text-gray-500 dark:text-gray-300 mb-7">
            ...
            <button
              ...
              on:click={() => copyToClipboard("rishurawat1703@gmail.com")}
              >rishurawat1703@gmail.com</button
            >
          </h5>
        </div>
